...
## 2026-05-04 - Fix hardcoded Supabase credentials
**Vulnerability:** Hardcoded Supabase URL and Publishable Key in src/integrations/supabase/client.ts.
**Learning:** The file is auto-generated but must still securely use environment variables (import.meta.env.VITE_SUPABASE_URL and import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY).
**Prevention:** Use environment variables for all secrets, even in auto-generated client files.
