-- PostgreSQL Migration: Phase 1 - Robust Payroll Proration for Joiners and Exits
-- Redefines process_payroll_run to check e.date_of_joining and employee_exits.last_working_day
...
BEGIN
    ...
    LOOP
        ...
        -- Check if employee exit records are present
        SELECT last_working_day INTO v_exit_date
