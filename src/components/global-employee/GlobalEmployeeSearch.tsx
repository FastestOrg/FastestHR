  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative group">
        ...
        <div className="relative flex items-center gap-3 bg-background/80 backdrop-blur-xl border border-border/50 rounded-2xl px-5 py-3 shadow-lg shadow-black/5 focus-within:border-primary/50 focus-within:shadow-primary/10 transition-all duration-300">
          <Search className="h-5 w-5 text-muted-foreground shrink-0" />
          <Input
            type="text"
            placeholder="Search by Name, Email, Phone, Aadhaar, PAN, Driving License, or Passport..."
            value={query}
        ...
        <div className="text-center py-16 space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              No employee or candidate matches "{query}". You can add them manually.
            </p>
          </div>
          {onAddNew && (
            <Button onClick={onAddNew} className="gap-2 mt-2">
